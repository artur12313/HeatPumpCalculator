<x-app-layout>
    ...
    <form>
      ...
      <button type="button" class="bg-green-600/75 hover:bg-green-600/50 text-white py-1 px-4 text-lg" id="previewTrigger" onclick="showPreview()">Podgląd</button>
    ...
    <script>
      ...
      function avgInstallment()
      {
        ...
        let malejaca_rata_kredytu = ((kwota_kredytu / liczba_rat) * (1 + (liczba_rat - i + 1) * oprocentowanie));
        ...
        //   kapitałWartosc = kredytWartosc - odestki;
