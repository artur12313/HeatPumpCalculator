<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="specialNumber" value="{{ __('numer pełnomocnictwa') }}" />
                <x-jet-input id="specialNumber" class="block mt-1 w-full" type="text" name="specialNumber" :value="old('specialNumber')" required autofocus autocomplete="specialNumber" />
            </div>
            <div class="mt-4">
