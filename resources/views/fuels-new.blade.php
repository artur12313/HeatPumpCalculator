    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Dodaj nowy rodzaj paliwa do ogrzewania') }}
            </h2>
        </div>
      ...
      <div>
        <div class="mt-4 flex justify-between items-center gap-2">
          ...
          <div class="md:w-1/2">
            ...
            <x-jet-input id="efficiency" class="block mt-1 w-full" type="number" name="efficiency" required autofocus />
          </div>
        </div>
        <div class="flex mt-4 justify-between items-end gap-2">
          <div class="md:w-1/3">
            <x-jet-label for="caloricValue" value="{{ __('Wartość kaloryczna') }}" />
            <x-jet-input id="caloricValue" class="block mt-1 w-full" type="number" name="caloricValue" required autofocus />
          </div>
          <div class="md:w-1/3">
